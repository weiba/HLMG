...
cv_set.to_csv("./HLMG/CCLE/Data/5-fold_CV_ic50.csv",index=False)
test_set.to_csv("./HLMG/CCLE/Data/testset_ic50.csv",index=False)
pd.DataFrame(true_datas).to_csv("./HLMG/CCLE/result_data/true_data_ic50.csv")
pd.DataFrame(predict_datas).to_csv("./HLMG/CCLE/result_data/predict_data_ic50.csv")
